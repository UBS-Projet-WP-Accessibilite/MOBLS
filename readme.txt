...
Un bouton flottant ouvre un module de personnalisation d’accessibilité et de confort de lecture. Le widget propose des réglages visuels, cognitifs, moteurs, de lecture audio et de démonstration braille visuelle. Il ne remplace pas un audit RGAA/WCAG, un lecteur d’écran, une plage braille ni une correction structurelle du site.
...
- `docs/GUIDE_UTILISATION_WIDGET.md` : contenu pédagogique du guide intégré au module.
